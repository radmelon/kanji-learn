...
- [ ] **Example Sentences for Vocab Words** — Show 1–2 short JLPT-appropriate example sentences on the CompoundCard, with the target vocabulary highlighted. Requires sourcing a sentence corpus (Tatoeba or a curated JLPT sentence dataset) and a new backend endpoint to serve sentences keyed by vocabulary.
