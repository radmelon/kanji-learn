...
const styles = StyleSheet.create({
  ...
  subDot: { ...typography.caption, color: colors.textSubtle },
  subMeaning: { ...typography.caption, color: colors.textSecondary },
  subJlpt: { ...typography.caption, fontWeight: '700' },
  counter: { ...typography.bodySmall, color: colors.textSubtle, paddingTop: 2 },
  ...
  modeBtnText: { ...typography.bodySmall, color: colors.textSubtle },
  ...
  chipNum: { ...typography.caption, color: colors.textSubtle, fontWeight: '600' },
  ...
  axisLabel: { ...typography.caption, color: colors.textSubtle },
