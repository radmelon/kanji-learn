...
const SEGMENT_DESCRIPTIONS: Record<string, string> = {
  learning: 'Interval < 7 days. New or recently failed cards — still building the initial memory.',
  reviewing: '7–20 day interval. Retention is forming; you\'ve answered correctly a few times.',
  remembered: '21–179 day interval. Solid long-term memory. Reviews are infrequent.',
  burned: '≥ 180 day interval (~6 months). Considered mastered. Still appears occasionally as a surprise check.',
  unseen: 'Not yet studied. Will be introduced gradually during daily sessions.',
}
