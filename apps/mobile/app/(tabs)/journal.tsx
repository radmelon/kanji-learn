...
const styles = StyleSheet.create({
  ...
  sectionTitle: { ...typography.bodySmall, color: colors.textSubtle, paddingHorizontal: spacing.md, paddingBottom: spacing.xs, fontWeight: '600' },
  list: { paddingHorizontal: spacing.md, paddingBottom: spacing.xxl },
  emptyState: { alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.xxl, gap: spacing.md },
  emptyTitle: { ...typography.h3, color: colors.textSecondary },
  emptySubtitle: { ...typography.bodySmall, color: colors.textSubtle, textAlign: 'center', paddingHorizontal: spacing.xl },
