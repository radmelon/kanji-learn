...
struct StudyView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Onboarding overlay — rendered as a ZStack layer rather than a .sheet
            // to avoid the watchOS crash caused by presenting a modal inside a
            // fullScreenCover while it is still animating.
